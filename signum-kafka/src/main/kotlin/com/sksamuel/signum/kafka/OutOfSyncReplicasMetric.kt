...
import com.sksamuel.signum.kafka.clients.TopicClient
import com.sksamuel.signum.kafka.clients.TopicPartitionInsync
...
class OutOfSyncReplicasMetric(
   ...
   companion object {
      const val MetricName = "signum.kafka.topic.partitions.replicas.outofsync"
